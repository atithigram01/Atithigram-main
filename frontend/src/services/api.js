...
// Adventures
export const getAdventures = (activityType) => API.get('/adventures', { params: { activityType } });
export const getAdventure = (id) => API.get(`/adventures/${id}`);
...
// AI Planner
export const askAI = (message, history) => API.post('/planner/chat', { message, history });
