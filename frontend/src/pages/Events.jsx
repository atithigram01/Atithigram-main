...
const EVENTS = [
  ...
  /* ── Tribal Ritual ── */
  {
    ...
    name: 'Pundru Kaph',
    emoji: '🌊',
    category: 'Tribal Ritual',
    badgeColor: 'bg-blue-100 text-blue-700',
    month: 'July',
    date: '18–20 Jul 2026',
    duration: '3 Days',
    location: 'Khunti & Ranchi Districts',
    district: 'Khunti, Ranchi, Simdega',
    attendees: '25,000+',
    rating: 4.8,
    image: 'https://images.unsplash.com/photo-1504701954957-2010ec3bcec1?q=80&w=800&auto=format&fit=crop',
    shortDesc: 'An ancient Munda tribal water-worship ritual deeply rooted in reverence for rivers and nature during the monsoon season.',
    fullDesc: 'Pundru Kaph is a sacred water-worship festival practiced by the Munda tribe of Jharkhand, typically held during the monsoon months when rivers swell. "Pundru" refers to a white flower and "Kaph" denotes the ritual offering. Community members gather at riverbanks at dawn to offer white flowers, rice, and sacred items to the flowing water, praying for good monsoon rains, healthy crops, and protection from floods. The priest (Pahan) leads sacred chants while youth perform the Jhumar dance. It is a rare, intimate festival offering an authentic window into Munda cosmology.',
    highlights: ['Sacred river-side puja at dawn', 'Munda Pahan-led chants & rituals', 'Traditional Jhumar dance performances', 'Tribal cuisine — Handia (rice beer) & Pittha'],
    tips: 'Photography is welcome but always ask permission before capturing rituals. Dress modestly and respectfully.',
    featured: true,
  },
  /* ── Nature Festival ── */
  {
  ...
  /* ── Tribal Festival ── */
  {
    ...
    shortDesc: 'A tribal festival dedicated to the worship of Budha Baba with unique suspension rituals and Chhau dance.',
    fullDesc: 'Bhagta Parab is highly popular among the tribal communities of the Tamar region of Jharkhand. Dedicated to Budha Baba, the highlight of the festival consists of devotees (Bhagtas) being suspended from a tall wooden pole and rotated. The evening is filled with energetic Chhau dance performances in the village Akhara.',
    highlights: ['Unique suspension rituals (Charak Puja)', 'Traditional Chhau mask dances', 'Devotional fasting by Bhagtas', 'Evening fairs in the Akhara'],
  ...
  /* ── Harvest Festival ── */
  {
    ...
    fullDesc: 'Sohrai is the most important harvest festival of the Santal, Munda, and Oraon tribes, celebrated after the rice harvest. It is a time for expressing gratitude to cattle that help in agriculture. Houses are beautifully painted with natural earth colors (Sohrai art), and cattle are washed, anointed with oil, and decorated. Joyful folk songs and dances accompany the rural festivities.',
      ...
      <section className="relative bg-gradient-to-br from-green-900 via-green-800 to-emerald-900 text-white py-24 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-yellow-400">Jharkhand</span>
          </motion.h1>
          ...
          >
            ...
            <strong className="text-yellow-400">Tusu Parab</strong> to the sacred water rites of{' '}
            <strong className="text-yellow-400">Pundru Kaph</strong> — immerse in authentic tribal festivities.
          </motion.p>
