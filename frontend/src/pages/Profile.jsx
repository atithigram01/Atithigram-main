...
import {
  User, Mail, Shield, Leaf, MapPin, Calendar, Edit3, Check, X, LogOut, Key
} from 'lucide-react';
        ...
        {activeTab === 'settings' && (
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-6">
            ...
            <div className="pt-6 border-t border-gray-100 space-y-4">
              <h4 className="font-bold text-sm text-dark flex items-center gap-2">
                <Key size={16} className="text-secondary" /> Change Account Password
              </h4>
              
              {passError && <div className="bg-red-50 text-red-600 p-3 rounded-xl text-xs">{passError}</div>}
              {passSuccess && <div className="bg-green-50 text-green-700 p-3 rounded-xl text-xs font-semibold">{passSuccess}</div>}
              ...
              <button
                ...
                className="bg-primary text-white px-5 py-2.5 rounded-xl text-xs font-bold hover:bg-green-900 transition-colors disabled:opacity-60 shadow-sm"
              >
