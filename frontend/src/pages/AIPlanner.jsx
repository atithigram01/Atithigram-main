...
function getResponse(message) {
  ...
  if (lower.match(/hello|hi|namaste|hey/)) return MOCK_RESPONSES.greet;
  if (lower.match(/waterfall|fall|hundru|jonha|dasam/)) return MOCK_RESPONSES.waterfall;
  if (lower.match(/temple|mandir|baidyanath|jagannath|rajrappa/)) return MOCK_RESPONSES.temple;
  if (lower.match(/tribal|culture|santal|munda|oraon|festival/)) return MOCK_RESPONSES.tribal;
  if (lower.match(/itinerary|plan|trip|days|schedule|route/)) return MOCK_RESPONSES.itinerary;
  if (lower.match(/homestay|stay|accommodation|hotel|host/)) return MOCK_RESPONSES.homestay;
  if (lower.match(/handicraft|craft|art|dokra|silk|basket/)) return MOCK_RESPONSES.handicraft;
  if (lower.match(/eco|point|reward|sustainable|green/)) return MOCK_RESPONSES.ecopoints;
