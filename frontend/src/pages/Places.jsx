...
const STATIC_PLACES = [
  ...
  { _id: '6', name: 'Sarhul Festival', category: 'Cultural', description: 'The main tribal festival of the Oraon and Munda tribes, celebrating spring.', images: ['/sarhul.jpg'], coordinates: { lat: 23.34, lng: 85.31 } },
